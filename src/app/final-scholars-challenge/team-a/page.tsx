      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5 py-6 max-w-lg mx-auto w-full space-y-4">
        ...
        {round === 'rapid_fire' && (
          <div className="w-full space-y-4">
            ...
            {/* idle (first-time before match starts) → show the full round
                instructions on the team page as well as the projector. */}
            {(s?.rf_phase === 'idle') && (
            ...
            {/* announce_a → team-a is being announced as up first */}
            {s?.rf_phase === 'announce_a' && (
              <div className={`rounded-2xl border-4 ${COLOR.border} bg-green-500/15 p-6 text-center animate-pulse shadow-[0_16px_40px_-12px_rgba(34,197,94,0.5)]`}>
                <p className={`text-[10px] font-black uppercase tracking-[0.35em] ${COLOR.text}`}>Up First</p>
            ...
            {/* announce_b → team-a is done and team-b is being announced */}
            {s?.rf_phase === 'announce_b' && (
              <div className="space-y-3">
                ...
                <div className="bg-purple-500/15 border-2 border-purple-500/50 rounded-2xl p-5 text-center animate-pulse">
                  <p className="text-purple-300 text-[10px] font-black uppercase tracking-[0.35em]">Up Next</p>
