        ...
        {round === 'mystery_chain' && s && (
          <div className="w-full space-y-6">
            ...
            {(s.mc_phase === 'a_playing' || s.mc_phase === 'b_playing' || s.mc_phase === 'c_playing') && (() => {
              ...
              return (
                <>
                  <div className={`rounded-3xl p-6 text-center border-2 ${timerWarn ? 'border-red-400 bg-red-500/10 animate-pulse' : timerSecs === 0 ? 'border-red-600 bg-red-900/20' : borderClass}`}>
