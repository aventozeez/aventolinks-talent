...
// ── Default pools ─────────────────────────────────────────────────────────
// 30 themed pools of 20 questions each. Pulled from fsc_questions during
...
const POOL_26: Omit<TBQuestion, 'id'>[] = [
...
const POOL_27: Omit<TBQuestion, 'id'>[] = [
...
const POOL_28: Omit<TBQuestion, 'id'>[] = [
...
const POOL_29: Omit<TBQuestion, 'id'>[] = [
...
const POOL_30: Omit<TBQuestion, 'id'>[] = [
...
const DEFAULT_POOLS = () => [
  ...
  makePool('Pool 25', POOL_25), makePool('Pool 26', POOL_26), makePool('Pool 27', POOL_27),
  makePool('Pool 28', POOL_28), makePool('Pool 29', POOL_29), makePool('Pool 30', POOL_30),
]
