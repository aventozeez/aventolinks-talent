$url = "https://pyzqhzoubvemkhprsjra.supabase.co/rest/v1/fsc_questions"
$key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InB5enFoem91YnZlbWtocHJzanJhIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NDYzOTQ1MiwiZXhwIjoyMDkwMjE1NDUyfQ.jEACx3nLh9BoLLwMbTH9p22z6MX8MXIWukzGsEcMcZ8"
...
$questions = @(
    ...
    @{ question="What is the process by which water turns into vapour?"; answer="Evaporation"; category="Science"; type="regular" }
...
try {
    ...
    Write-Host "Success! Status: $($response.StatusCode) — 30 questions inserted."
} catch {
    Write-Host "Error: $_"
}
